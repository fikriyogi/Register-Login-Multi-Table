...
<!DOCTYPE html>
<!-- saved from url=(0089)http://192.241.236.31/themes/preview/smartadmin/1.8.x/ajax/index.html#ajax/dashboard.html -->
<html lang="en-us"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		{
		$('#responsecontainer').load('load/user_online.php');
		}, 1000);
		</script>
	...
	<body class="smart-style-0 desktop-detected fixed-header fixed-navigation">
			...
			<nav>
				...
				<ul style="">
					<li class="active open">
						<a href="http://192.241.236.31/themes/preview/smartadmin/1.8.x/ajax/index.html#" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Dashboard</span><b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b></a>
						<ul style="display: block;">
							<li class="active">
								<a href="index.html" title="Dashboard"><span class="menu-item-parent">Analytics Dashboard</span></a>
						  </li>
							<li class="">
								<a href="Social Wall.html" title="Dashboard"><span class="menu-item-parent">Social Wall</span></a>
							</li>
						</ul>	
					</li>
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb"><li>Home</li><li>Dashboard</li><li>Analytics Dashboard</li></ol>
				<!-- end breadcrumb -->
...
<li class="paper" id="forum-row-934">
<div class="row">
<div class="col-sm-6">
<div class="forum-badge">
<a class="forum-avatar" href="https://www.domestika.org/es/forums/934-3d">3D</a>
<h2>
<a class="forum-name" href="https://www.domestika.org/es/forums/934-3d">3D</a>
</h2>
<p>Trabajos en 3D y noticias del sector.</p>
</div>
</div>
<div class="col-sm-4">
<div class="topic-badge-wrapper hidden-xs hidden-sm">
<div class="topic-badge topic-badge--m">
<a href="https://www.domestika.org/en/msm9292"><span class="avatar avatar--s">
<img title="" alt="Msm9292" class="has-tooltip" src="img/avatar_default_32x32-dc178afc7fdb295cd4218e2ae0dc99e5.gif" data-original-title="Msm9292">
</span>
</a><h3 class="title t-topic-title">
<a href="https://www.domestika.org/es/forums/934-3d/topics/119180-por-donde-empiezo">¿por donde empiezo?</a>
</h3>
<div class="metadata">
<a title="esmerocreativo" href="https://www.domestika.org/es/forums/934-3d/topics/119180-por-donde-empiezo#post_827014">recent comment</a>
<span class="js-timeago" title="7 days ago">7 days ago</span>
...
<div class="col-sm-2">
<p class="topic-count">
<a href="https://www.domestika.org/es/forums/934-3d"><i class="fa fa-tasks i-space-right"></i>
945 topics
</a></p>
</div>
</div>
			...
			<div class="jarviswidget jarviswidget-sortable" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false" role="widget">
				...
				<header role="heading">
					...
					<ul class="nav nav-tabs pull-right in" id="myTab">
						<li class="active">
							<a data-toggle="tab" href="http://192.241.236.31/themes/preview/smartadmin/1.8.x/ajax/index.html#s1"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">Live Stats</span></a>
						</li>

						<li>
							<a data-toggle="tab" href="http://192.241.236.31/themes/preview/smartadmin/1.8.x/ajax/index.html#s2"><i class="fa fa-facebook"></i> <span class="hidden-mobile hidden-tablet">Social Network</span></a>
						</li>

						<li>
							<a data-toggle="tab" href="http://192.241.236.31/themes/preview/smartadmin/1.8.x/ajax/index.html#s3"><i class="fa fa-dollar"></i> <span class="hidden-mobile hidden-tablet">Revenue</span></a>
						</li>
					</ul>
							...
							<div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1">
								<div class="row no-space">
									<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
										...
										<div id="updating-chart" class="chart-large txt-color-blue" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 719px; height: 235px;" width="719" height="235"></canvas><div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);"><div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 26px; text-align: center;">0</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 91px; text-align: center;">10</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 159px; text-align: center;">20</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 227px; text-align: center;">30</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 295px; text-align: center;">40</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 363px; text-align: center;">50</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 431px; text-align: center;">60</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 499px; text-align: center;">70</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 567px; text-align: center;">80</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 635px; text-align: center;">90</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 65px; top: 220px; left: 700px; text-align: center;">100</div></div><div class="flot-y-axis flot-y1-axis yAxis y1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; top: 203px; left: 13px; text-align: right;">0</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 163px; left: 7px; text-align: right;">20</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 123px; left: 7px; text-align: right;">40</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 83px; left: 7px; text-align: right;">60</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 43px; left: 7px; text-align: right;">80</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 3px; left: 0px; text-align: right;">100</div></div></div><canvas class="flot-overlay" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 719px; height: 235px;" width="719" height="235"></canvas></div>
			...
			<a href="javascript:void(0);" class="msg">
				...
				<span class="msg-body">Nam libero tempore, cum soluta nobis est eligendi optio cumque</span>
							...
							<div class="tab-pane fade" id="s3">
								...
								<div class="padding-10">
									<div id="flotcontainer" class="chart-large has-legend-unique" style="padding: 0px; position: relative;"><canvas class="flot-base" width="100" height="235" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 100px; height: 235px;"></canvas><div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);"><div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 16px; top: 235px; left: 13px; text-align: center;">2013</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 16px; top: 235px; left: 35px; text-align: center;">2014</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 16px; top: 235px; left: 57px; text-align: center;">2015</div><div class="flot-tick-label tickLabel" style="position: absolute; max-width: 16px; top: 235px; left: 79px; text-align: center;">2016</div></div><div class="flot-y-axis flot-y1-axis yAxis y1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;"><div class="flot-tick-label tickLabel" style="position: absolute; top: 225px; left: 0px; text-align: right;">0</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 182px; left: 0px; text-align: right;">250</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 139px; left: 0px; text-align: right;">500</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 96px; left: 0px; text-align: right;">750</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 53px; left: 0px; text-align: right;">1000</div><div class="flot-tick-label tickLabel" style="position: absolute; top: 10px; left: 0px; text-align: right;">1250</div></div></div><canvas class="flot-overlay" width="100" height="235" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 100px; height: 235px;"></canvas><div class="legend"><div style="position: absolute; width: 0px; height: 0px; top: -22px; right: 5px; opacity: 1;"> </div><table style="position:absolute;top:-22px;right:5px;;font-size:smaller;color:#545454"><tbody><tr><td class="legendColorBox"><div style=""><div style="border:2px solid rgb(147,19,19);overflow:hidden"></div></div></td><td class="legendLabel"><span>Target Profit</span></td><td class="legendColorBox"><div style=""><div style="border:2px solid #3276B1;overflow:hidden"></div></div></td><td class="legendLabel"><span>Actual Profit</span></td><td class="legendColorBox"><div style=""><div style="border:2px solid #71843F;overflow:hidden"></div></div></td><td class="legendLabel"><span>Actual Signups</span></td></tr></tbody></table></div></div>
								</div>
							</div>
							<!-- end s3 tab pane -->
						</div>
	...
	<div class="row">
		...
		<article class="col-sm-12 col-md-12 col-lg-6 sortable-grid ui-sortable">
			...
			<!-- new widget -->
			<div class="jarviswidget jarviswidget-color-blueDark jarviswidget-sortable" id="wid-id-1" data-widget-editbutton="false" data-widget-fullscreenbutton="false" role="widget">
					...
					<div class="widget-body widget-hide-overflow no-padding">
						...
						<!-- <div id="chat-container">
							...
							<div class="chat-list-body custom-scroll">
								<ul id="chat-users">
									<li>
										<a href="javascript:void(0);"><img src="img/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
									</li>
									<li>
										<a href="javascript:void(0);"><img src="img/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
									</li>
								</ul>
							</div>
...
<script type="text/javascript">
	...
	pagefunction();
		...
		<script src="js/voicecommand.min.js"></script><div class="modal fade" id="voiceModal" tabindex="-1" role="dialog" aria-labelledby="remoteModalLabel" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"></div></div></div>

		<!-- SmartChat UI : plugin -->
		<script src="js/smart.chat.ui.min.js"></script>
		<script src="js/smart.chat.manager.min.js"></script>
...
<div id="divSmallBoxes"></div><div id="divMiniIcons"></div><div id="divbigBoxes"></div><script type="text/javascript" src="js/jquery.flot.cust.min.js"></script><script type="text/javascript" src="js/jquery-jvectormap-1.2.2.min.js"></script><script type="text/javascript" src="js/moment.min.js"></script><script type="text/javascript" src="js/jquery.flot.resize.min.js"></script><script type="text/javascript" src="js/jquery-jvectormap-world-mill-en.js"></script><script type="text/javascript" src="js/jquery.fullcalendar.min.js"></script><script type="text/javascript" src="js/jquery.flot.time.min.js"></script><script type="text/javascript" src="js/jquery.flot.tooltip.min.js"></script><div id="flotTip" style="display: none; position: absolute;"></div><div class="jvectormap-label"></div></body></html>