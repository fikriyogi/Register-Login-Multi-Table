<?php
	...
	if( isset($_POST['btn-login']) ) {	
		...
		$res1=mysql_query("UPDATE users SET status='1' where userEmail='$email'");
		$row=mysql_fetch_array($res);
		$count = mysql_num_rows($res); // if uname/pass correct it returns must be 1 row
		
		$query1 = "INSERT INTO log(id_user,ip_address,browser,timestamp) VALUES('$userId','$ip_address','$browser',NOW())";
